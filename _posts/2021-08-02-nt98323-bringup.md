...
* 常见故障问题
  ...
  目前遇到的图像异常问题主要是`BT656`时钟相关的配置问题：

  ![NVP6124i Register VCLK][nvp6124_vclk_reg_config]

  * 画面抖动

    表现为摄像头画面边缘上下抖动，接更多路摄像头时抖动更加严重：

    ![NVP6124 输出图像抖动问题][nvp6124_output_problem_flick]
...
[nvp6124_output_problem_flick]: /images/nvp6124_output_problem_flick.gif
